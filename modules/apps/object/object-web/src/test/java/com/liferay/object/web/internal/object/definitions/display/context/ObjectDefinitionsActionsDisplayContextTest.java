...
public class ObjectDefinitionsActionsDisplayContextTest {
	...
	public void testGetObjectActionCodeEditorElements() throws Exception {
		...
		Map<String, List<Map<String, String>>>
			objectActionCodeEditorElementsMap = new HashMap<>();

		for (Map<String, Object> objectActionCodeEditorElement :
				objectActionCodeEditorElements) {

			objectActionCodeEditorElementsMap.put(
		...
		Assert.assertEquals(
			objectActionCodeEditorElementsMap.toString(), 4,
			objectActionCodeEditorElementsMap.size());
		Assert.assertTrue(
			objectActionCodeEditorElementsMap.containsKey("fields"));
		Assert.assertTrue(
			objectActionCodeEditorElementsMap.containsKey("general-variables"));
		Assert.assertTrue(
			objectActionCodeEditorElementsMap.containsKey("operators"));
		Assert.assertTrue(
			objectActionCodeEditorElementsMap.containsKey("functions"));

		List<Map<String, String>> fields =
			objectActionCodeEditorElementsMap.get("fields");
		...
		List<Map<String, String>> functions =
			objectActionCodeEditorElementsMap.get("functions");
		...
		Assert.assertEquals(
			...
			_getContents(
				objectActionCodeEditorElementsMap.get("general-variables")));

		List<Map<String, String>> operators =
			objectActionCodeEditorElementsMap.get("operators");

		...
		for (String projectScopeKey : projectScopeKeys) {
			...
			try {
				_objectEntryService.addObjectEntry(
					projectGroupId,
					projectLinkObjectDefinition.getObjectDefinitionId(), 0,
					null,

...
import com.liferay.data.engine.internal.upgrade.v1_1_1.UpgradeJournalStructuresToDataEngine;
...
public class DEServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"1.1.0", "1.1.1",
			new UpgradeJournalStructuresToDataEngine(_counterLocalService));
	}

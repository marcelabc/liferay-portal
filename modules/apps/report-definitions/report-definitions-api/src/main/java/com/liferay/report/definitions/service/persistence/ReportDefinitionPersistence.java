 ...
 */
@ProviderType
public interface ReportDefinitionPersistence
	extends BasePersistence<ReportDefinition> {
	 ...
	 */
	public java.util.List<ReportDefinition> findByUuid(
	...
	public java.util.List<ReportDefinition> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ReportDefinition>
			orderByComparator);
	 ...
	 * @return the matching report definitions
	 */
	public java.util.List<ReportDefinition> findByUuid_C(
	 ...
	 * @return the range of matching report definitions
	 */
	public java.util.List<ReportDefinition> findByGroupId(

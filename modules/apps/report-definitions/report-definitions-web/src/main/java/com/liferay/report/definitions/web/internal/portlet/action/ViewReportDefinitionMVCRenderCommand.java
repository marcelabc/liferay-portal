...
@Component(
	...
	property = {
		...
		"mvc.command.name=/view_report_definition"
	},
	service = MVCRenderCommand.class
)
public class ViewReportDefinitionMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		return "/META-INF/resources/view_report_definition.jsp";
	}

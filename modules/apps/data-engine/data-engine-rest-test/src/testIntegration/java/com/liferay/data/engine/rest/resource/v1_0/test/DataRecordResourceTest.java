...
public class DataRecordResourceTest extends BaseDataRecordResourceTestCase {
	...
	public void testSaveDataRecordWithInvalidDataRecordCollection()
		throws Exception {

		DataRecord randomDataRecord = randomDataRecord();

		DataRecordResource.postDataRecordCollectionDataRecord(
			Long.valueOf(12345), randomDataRecord);
	}

	@Test(expected = Exception.class)
	public void testSaveDataRecordWithoutMatchingDataDefinitionFields()
		throws Exception {

		DataRecord dataRecord = _createDataRecord("Wrong Field");

		testPostDataRecordCollectionDataRecord_addDataRecord(dataRecord);
	}

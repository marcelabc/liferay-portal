...
import com.liferay.data.engine.rest.internal.field.type.v1_0.FieldTypeFactory;
...
public class DataLayoutRenderer {
			...
			_createDataLayoutPagesContexts(
				_getDataDefinitionFieldsMap(
					DataDefinitionUtil.toDataDefinition(
						ddmStructureLocalService.getStructure(dataLayoutId))),
	...
	private List<Object> _createFieldTypesContexts(
		...
		for (String fieldName : fieldNames) {
			...
			FieldTypeFactory.includeFieldTypeContext(

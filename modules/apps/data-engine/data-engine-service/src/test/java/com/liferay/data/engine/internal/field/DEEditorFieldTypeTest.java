...
public class DEEditorFieldTypeTest extends DEBaseFieldTypeTest {

	@Test
	public void testIncludeContext() {
		DEDataDefinitionField deDataDefinitionField =
			createDEDataDefinitionField("field1", "editor");
		...
		DEEditorFieldType editorFieldType = new DEEditorFieldType();

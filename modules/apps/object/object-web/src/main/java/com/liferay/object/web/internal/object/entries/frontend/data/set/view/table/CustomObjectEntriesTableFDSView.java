...
import com.liferay.object.web.internal.js.loader.modules.extender.npm.NPMResolverProvider;
...
@Component(
	enabled = false,
	property = "frontend.data.set.name=com_liferay_object_web_internal_object_definitions_portlet_ObjectDefinitionsPortlet_43747",
	service = FDSView.class
)
public class CustomObjectEntriesTableFDSView extends BaseTableFDSView {
	...
	public FDSTableSchema getFDSTableSchema(Locale locale) {
		...
		if (defaultObjectView == null) {
			_addAllObjectFields(
				fdsTableSchemaBuilder, locale, objectDefinition);
		...
		if (Objects.equals(
			...
			if (Objects.equals(
				...
				String moduleName = npmResolver.resolveModuleName(
					"@liferay/object-js-components-web/components/IconCheckRenderer");

				stringFDSTableSchemaField.setContentRendererModuleURL(
					moduleName);
			}
